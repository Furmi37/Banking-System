...
class AccountServiceTest {
    ...
    void shouldCreateAccountWhenCallCreateAccount() {
        //given
        Account account = new Account(null,"Monthy Python", "monthy@gmail.com", "867349934", 1000.0, 2345, null);
    ...
    void shouldGetAccountWhenCallGetAccount() {
        ...
        Account account = new Account(null,"Monthy Python", email, "867349934", 1000.0, 2345, null);
    ...
    void shouldGetTwoAccountsWhenCallGetAccounts() {
        //given
        Account account1 = new Account(null,"Monthy Python", "monthy@gmail.com", "867349934", 1000.0, 2345, null);
        Account account2 = new Account(null,"Susan Wright", "susan@gmail.com", "546345654364", 2000.0, 1234, null);
    ...
    void shouldFindAccountByIdWhenCallFindById() {
        //given
        long id = 1;
        Account account = new Account(id,"Monthy Python", "monthy@gmail.com", "867349934", 1000.0, 2345, null);
